        ...
        <div className="footer-main">
          <div className="footer-inner">
            <div className="footer-brand-col">
              ...
              {/* ── Stats row ── */}
              <div className="footer-stats-strip" style={{ marginTop: 'auto' }}>
            ...
            <div className="footer-links-col">
              ...
              {/* ── Social icons ── */}
              <div className="footer-social-badges-row" style={{ marginTop: 'auto' }}>
            ...
            <div className="footer-links-col">
              ...
              {/* ── App badges ── */}
              <div className="footer-app-badges" style={{ marginTop: 'auto' }}>
